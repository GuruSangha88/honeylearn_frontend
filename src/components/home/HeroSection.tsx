...
const HeroSection = ({
  ...
  return <section className="bg-tutor-dark py-16 md:py-24">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1">
          <div className="aspect-video bg-tutor-dark-gray rounded-xl overflow-hidden">
            <img src="https://images.unsplash.com/photo-1605810230434-7631ac76ec81" alt="Kids learning with HoneyLearn" className="w-full h-full object-cover" />
          </div>
        </div>
      </div>
    </section>;
